...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/transaksi/cancel', [TransaksiController::class, 'cancel'])->name('transaksi.cancel');
    Route::post('/transaksi/{transaksi}/cancel-admin', [TransaksiController::class, 'cancelByAdmin'])->name('transaksi.cancel-admin');
