...
@section('content')
    <section id="hero" class="hero section dark-background">
        <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-container">
                    ...
                    <p>PT Prima Andalas — Pilar Kepercayaan dalam Menyediakan Hasil
                        Perkebunan Premium, Siap Melayani Pasar Ekspor dengan Standar
                        Mutu Tinggi dan Komitmen Tanpa Kompromi.</p>
                </div>
            </div><!-- End Carousel Item -->

            <div class="carousel-item">
                <img src="assets/img/perkebunan2.jpg" alt="">
                <div class="carousel-container">
                    <h2>Sayuran organik baik untuk kesehatan</h2>
                    <p>Dengan Dedikasi pada Keaslian dan Kesegaran, Kami Menyediakan Sayuran Organik yang Menyehatkan,
                        Mendukung Anda dalam Menjalani Hidup Berkualitas dan Harmonis dengan Alam.</p>
                </div>
            </div><!-- End Carousel Item -->
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-container">
                    <h2>Bertani sebagai Sebuah Passion</h2>
                    <p>Kami percaya bahwa bertani bukan sekadar pekerjaan, tapi panggilan hati.
                        Dengan penuh dedikasi dan cinta terhadap tanah serta tanaman, kami berkomitmen
                        menghadirkan hasil panen terbaik yang alami dan berkualitas tinggi, sebagai wujud
                        nyata dari passion kami di dunia pertanian.</p>
                </div>
            </div><!-- End Carousel Item -->
    ...
    <section id="services" class="services section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <h2>SERVICES</h2>
            <p>SERVICE YANG KAMI LAKUKAN SETIAP HARI DI PERKEBUNAN</p>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Penanaman</h3>
                                <p>
                                    Layanan penanaman tanaman dengan metode yang tepat untuk hasil yang subur dan tahan
                                    lama.
                                </p>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Panen</h3>
                                <p>
                                    Gravida sodales condimentum pellen tesq accumsan orci quam
                                    sagittis sapie
                                </p>
                            ...
                            <div class="swiper-slide">
                                <div class="card h-100 shadow-sm border-0 rounded-3 overflow-hidden">
                                    <a href="{{ $item->tautan }}" class="text-decoration-none text-dark"
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            <h5 class="fw-semibold mb-2">{{ limit_teks($item->kutipan, 100, '...') }}
                                            </h5>
                                            <div
