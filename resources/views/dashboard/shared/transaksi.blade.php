...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="mb-3 d-flex gap-2">
            <div class="dropdown">
                <button class="btn btn-success dropdown-toggle" type="button" id="statusDropdown" data-bs-toggle="dropdown"
                    aria-expanded="false">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-1">
                                            ...
                                            @if (in_array($t->status, ['menunggu', 'proses']))
                                                <button type="button" class="btn btn-sm btn-danger"
                                                    data-crud="cancel-admin"
                                                    data-url="{{ route('transaksi.cancel-admin', $t->id) }}"
                                                    data-id="{{ $t->id }}">
